...
insertIntoSensor(sessionLuis, flat_j1, 2)
insertIntoSensor(sessionLuis, flat_j2, 1)
insertIntoSensor(sessionMarta, flat_j3, 2)
insertIntoSensor(sessionLuis, flat_j4, 3)
insertIntoSensor(sessionLuis, flat_j5, 1)
insertIntoSensor(sessionLuis, flat_j6, 4)
insertIntoSensor(sessionMarta, flat_j7, 2)
insertIntoSensor(sessionLuis, flat_j8, 4)
insertIntoSensor(sessionMarta, flat_j9, 2)
insertIntoSensor(sessionLuis, flat_j10, 1)
insertIntoSensor(sessionMarta, flat_j11, 2)
insertIntoSensor(sessionLuis, flat_j12, 10)
insertIntoSensor(sessionLuis, flat_j13, 1)
insertIntoSensor(sessionLuis, flat_j14, 18)
insertIntoSensor(sessionLuis, flat_j15, 21)
insertIntoSensor(sessionLuis, flat_j16, 1)
insertIntoSensor(sessionLuis, flat_j17, 21)
insertIntoSensor(sessionLuis, flat_j18, 12)
insertIntoSensor(sessionLuis, flat_j19, 18)
insertIntoSensor(sessionLuis, flat_j20, 21)
insertIntoSensor(sessionMarta, flat_j21, 2)
insertIntoSensor(sessionMarta, flat_j20, 2)
insertIntoSensor(sessionMarta, flat_j19, 2)
insertIntoSensor(sessionMarta, flat_j18, 2)
insertIntoSensor(sessionMarta, flat_j17, 2)
insertIntoSensor(sessionMarta, flat_j16, 2)
insertIntoSensor(sessionMarta, flat_j15, 2)
insertIntoSensor(sessionMarta, flat_j14, 2)
insertIntoSensor(sessionLuis, flat_j15, 1)
insertIntoSensor(sessionLuis, flat_j14, 3)
finishTimeI = time.time()
print("Inserting --- %s seconds ---" % (finishTimeI - startTimeI))

startTime1 = time.time()
queryResult1 = rangeQueryPerUser(sessionLuis, ['temperature'], {'temperature': '<13'}, '2020-06-02 10:10:10', '2021-08-01 22:36:20.785976')
finishTime1 = time.time()

startTime2 = time.time()
queryResult2 = queryPerUser(sessionLuis, ['temperature'], {'temperature': '=12'})
finishTime2 = time.time()

startTime3 = time.time()
queryResult3 = queryPerSensor(sessionMarta, '2', ['sensorid'], {'temperature': '=12'})
finishTime3 = time.time()

startTime5 = time.time()
queryResult5 = queryPerUser(sessionLuis, ['AVG:temperature'], {'sensorid': '=1'})
finishTime5 = time.time()

startTime6 = time.time()
queryResult6 = queryPerUser(sessionLuis, ['MIN:temperature'], {'sensorid': '=1'})
finishTime6 = time.time()

startTime7 = time.time()
queryResult7 = queryPerUser(sessionLuis, ['MAX:temperature'], {'sensorid': '=1'})
finishTime7 = time.time()

startTime8 = time.time()
queryResult8 = queryPerUser(sessionLuis, ['SUM:temperature'], {'sensorid': '=1'})
finishTime8 = time.time()

startTime9 = time.time()
queryResult9 = queryPerUser(sessionLuis, ['CNT:temperature'], {'sensorid': '=1'})
finishTime9 = time.time()

startTime10 = time.time()
queryResult10 = queryPerUser(sessionLuis, ['CNT:temperature'], {'sensorid': '=1', 'timestamp': '>2020-06-02 10:10:10'})
finishTime10 = time.time()

startTime11 = time.time()
queryResult11 = rangeQueryPerSensor(sessionMarta, '2', ['sensorid'], {'temperature': '>10', 'sensorid': '=2'}, '2020-06-02 10:10:10', '2021-08-01 22:36:20.785976')
